...
class ImapFolderTest extends TestCase
{
    public function testInitialState()
    {
        ...
        $folder->checkValidity([Horde_ActiveSync_Folder_Imap::UIDVALIDITY => '123']);
        $thrown = true;
        ...
        $this->assertEquals([], $folder->flags());
        $this->assertEquals([], $folder->added());
        $this->assertEquals([], $folder->changed());
        $this->assertEquals([], $folder->removed());
    ...
    {
        $folder = new Horde_ActiveSync_Folder_Imap('INBOX', Horde_ActiveSync::CLASS_EMAIL);
        $status = [Horde_ActiveSync_Folder_Imap::UIDVALIDITY => 100, Horde_ActiveSync_Folder_Imap::UIDNEXT => 105];

        // Initial state for nonmodseq
        $msg_changes = [100, 101, 102, 103, 104];
        $flag_changes = [
            100 => ['read' => 0, 'flagged' => 0],
            101 => ['read' => 0, 'flagged' => 0],
            102 => ['read' => 0, 'flagged' => 0],
            103 => ['read' => 0, 'flagged' => 0],
            104 => ['read' => 0, 'flagged' => 0],
        ];
        ...
        $flag_changes = [
            100 => ['read' => 0, 'flagged' => 1],
            101 => ['read' => 0, 'flagged' => 0],
            102 => ['read' => 0, 'flagged' => 0],
            103 => ['read' => 0, 'flagged' => 0],
            104 => ['read' => 0, 'flagged' => 0],
            105 => ['read' => 1, 'flagged' => 0],
        ];
        $folder->setChanges($msg_changes, $flag_changes);
        $this->assertEquals([105], $folder->added());
        $this->assertEquals([100], $folder->changed());
    ...
    {
        $folder = new Horde_ActiveSync_Folder_Imap('INBOX', Horde_ActiveSync::CLASS_EMAIL);
        $status = [Horde_ActiveSync_Folder_Imap::UIDVALIDITY => 100, Horde_ActiveSync_Folder_Imap::UIDNEXT => 105, Horde_ActiveSync_Folder_Imap::HIGHESTMODSEQ => 200];
